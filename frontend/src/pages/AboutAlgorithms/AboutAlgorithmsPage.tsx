...
export default function AboutAlgorithmsPage() {
  ...
  const nruAlgorithmText = `O NRU divide as páginas em classes, combinando os bits R e M, e a página de classe mais baixa é removida. Apesar de ser fácil de implementar, ele é rudimentar.`;
